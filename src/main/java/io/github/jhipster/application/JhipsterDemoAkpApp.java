...
public class JhipsterDemoAkpApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterDemoAkpApp.class);

    private final Environment env;

    public JhipsterDemoAkpApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterDemoAKP.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterDemoAkpApp.class);
